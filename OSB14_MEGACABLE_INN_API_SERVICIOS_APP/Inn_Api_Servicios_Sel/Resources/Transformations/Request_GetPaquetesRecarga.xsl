  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="GetPaquetesRecargaRequest" namespace="http://xmlns.oracle.com/inn/serviciosweb/types"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
  </oracle-xsl-mapper:schema>
  <xsl:param name="numero"/>
  <xsl:template match="/">
    <tns:GetPaquetesRecargaRequest>
      <tns:numero><xsl:value-of select="$numero"/></tns:numero>
      <tns:servicio/>
    </tns:GetPaquetesRecargaRequest>
  </xsl:template>
</xsl:stylesheet>
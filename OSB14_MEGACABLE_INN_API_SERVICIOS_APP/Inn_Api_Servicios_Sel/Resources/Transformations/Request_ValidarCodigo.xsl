  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="ValidarCodigoRequest" namespace="http://xmlns.oracle.com/inn/serviciosweb/types"/>

  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="ReiniciarEquipoRequest" namespace="http://xmlns.oracle.com/inn/serviciosweb/types"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
  </oracle-xsl-mapper:schema>
  <xsl:param name="authorization"/>
  <xsl:param name="idSuscriptor"/>
  <xsl:template match="/">
    <tns:ReiniciarEquipoRequest>
      <tns:authorization><xsl:value-of select="$authorization"/></tns:authorization>
      <tns:idSuscriptor><xsl:value-of select="$idSuscriptor"/></tns:idSuscriptor>
    </tns:ReiniciarEquipoRequest>
  </xsl:template>
</xsl:stylesheet>